...
<html>
  ...
  <body>
	<form action="${pageContext.request.contextPath}/TeaArticleServlet?method=add" method="post" enctype="multipart/form-data">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
	 				<label>标题</label><input class="layui-input" type="text" name="title" id="title" ><br />
					<label>时间</label><input class="layui-input" type="text" name="date" id="date"><br />
					<label>封面</label><input class="layui-input" type="file" name="img" id="img" ><br />
					<label>所属内容</label>
					<select name="teaChildId" lay-verify="required">
